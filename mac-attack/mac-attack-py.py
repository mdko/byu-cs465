...
def sha1(message):
    ...
    # Pre-processing:
    # I calculated this 192 because the whole message
    # (which I found with my Go program), is 2 512 bit
    # chunks long, + my message, which is exactly 512 bits, so a total of 192 bytes or 1532 bits
    original_byte_len = 192 #len(message)
    ...
    # start it at a different location because we're in the middle of hashing the 
    # "whole" message sent from alice, really starting in the middle
