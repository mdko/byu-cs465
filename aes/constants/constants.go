...
Nk = 8		// Number of 32-bit words comprising the Cipher Key (4 for 128-bit, 6 for 192, or 8 for 256)
Nr = 14		// Number of rounds, which is 10 for 128-bit, 12 for 192-bit, and 14 for 256-bit
Debug = true
)
